config = {
    "DEFAULT": {
        ...
        "img_host_2": "onlyimage",
        "img_host_3": "",
        "img_host_4": "",
        "img_host_5": "",

        # image host api keys - ADD PTSCREENS AND ONLYIMAGE
        "imgbb_api": "",
        "ptpimg_api": "",
        "lensdump_api": "",
        "ptscreens_api": "",
        ...
        # Can be overridden in a per-tracker setting by adding this same config
        "screenshot_header": "[h3][center]•─────• [color=#FFDA03]Screenshots[/color] •─────•",

        # Allows adding a custom signature, in BBCode, at the bottom of the description section
        # Can be overridden in a per-tracker setting by adding this same config
        "custom_signature": "[center]flower is currently looking for nothing but competition![/center]",
    ...
    "TRACKERS": {
        ...
        # Available tracker: ACM, AITHER, AL, ANT, AR, ASC, AZ, BHD, BHDTV, BJS, BLU, BT, CBR, CZ, DC, DP, EMUW, FF, FL, FNP, FRIKI, GPW, HDB, HDS, HDT, HHD, HUNO, IHD, IS, ITT, LCD, LDU, LST, LT, MTV, NBL, OE, OTW, PHD, PT, PTER, PTP, PTS, PTT, R4E, RAS, RHD, RF, RTF, SAM, SHRI, SN, SP, SPD, STC, THR, TIK, TL, TTG, TTR, TVC, ULCX, UTP, YOINK, YUS
