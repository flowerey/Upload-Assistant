...
class Args():
    ...
    def parse(self, args, meta):
        ...
        parser.add_argument('-cs', '--custom-source', nargs=1, required=False, help="Custom source for description (optional)", type=str)
        ...
        parser.add_argument('-emby_debug', '--emby_debug', action='store_true', required=False, help="Does debugging stuff for flower")
